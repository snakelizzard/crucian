...
public:
    ...
    void shuffle(RandomAccessIterator first, RandomAccessIterator last)
    {
        ...
        while (first != last)
        {
            // Pick a random position between the current and the end to swap
...
protected:
    ...
    // If not set when we call Random constructor, then the singleton is
    // allocated and seeder_ is set to a function that uses our singleton
